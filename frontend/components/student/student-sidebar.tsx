          ...
          {menuItems.map((item) => (
            <Link
              ...
              className={cn(
                ...
                isActive(item.href)
                  ? "bg-gradient-to-r from-indigo-500/20 to-purple-500/20 text-indigo-500 border border-indigo-500/20"
          ...
          {menuItems.map((item) => (
            <Link
              ...
              className={cn(
                ...
                isActive(item.href) ? "text-indigo-500" : "text-muted-foreground"
              )}
            >
