...
const menuItems = [
  { icon: LayoutDashboard, label: "Dashboard", href: "/accountant" },
  {
    ...
    subItems: [
      { label: "All Invoices", href: "/accountant/invoices" },
      { label: "Pending", href: "/accountant/invoices/pending" },
      { label: "Overdue", href: "/accountant/invoices/overdue" },
    ],
  },
  {
    icon: CreditCard,
    ...
    subItems: [
      { label: "Transactions", href: "/accountant/payments" },
      { label: "Refunds", href: "/accountant/payments/refunds" },
      { label: "Payouts", href: "/accountant/payments/payouts" },
    ],
  },
  {
    icon: PieChart,
    ...
    subItems: [
      { label: "Financial Summary", href: "/accountant/reports" },
      { label: "Revenue", href: "/accountant/reports/revenue" },
      { label: "Expenses", href: "/accountant/reports/expenses" },
      { label: "Tax Reports", href: "/accountant/reports/tax" },
    ],
  },
  { icon: DollarSign, label: "Billing", href: "/accountant/billing" },
  { icon: FileText, label: "Statements", href: "/accountant/statements" },
]

const bottomItems = [
  { icon: Settings, label: "Settings", href: "/accountant/settings" },
  { icon: Globe, label: "View Site", href: "/" },
  { icon: HelpCircle, label: "Help", href: "/accountant/help" },
]
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-white/20">
          <Link href="/accountant" className={cn("flex items-center gap-2", collapsed && "justify-center")}>
            ...
            {!collapsed && (
              <div>
                ...
                <span className="block text-xs text-muted-foreground">Accountant</span>
              </div>
            )}
          </Link>
          <button
                ...
                <>
                  <button
                    ...
                    className={cn(
                      ...
                      isActive(item.href)
                        ? "bg-gradient-to-r from-emerald-500/20 to-green-600/20 text-emerald-500 border border-emerald-500/20"
