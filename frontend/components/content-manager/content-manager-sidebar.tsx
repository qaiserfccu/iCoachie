    ...
    <>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-white/20">
          <Link href="/content-manager" className={cn("flex items-center gap-2", collapsed && "justify-center")}>
            ...
            {!collapsed && (
              <div>
                ...
                <span className="block text-xs text-muted-foreground">Content Manager</span>
              </div>
            )}
          </Link>
          ...
          {menuItems.map((item) => (
            <Link
              ...
              className={cn(
                ...
                isActive(item.href)
                  ? "bg-gradient-to-r from-violet-500/20 to-purple-600/20 text-violet-500 border border-violet-500/20"
          ...
          {menuItems.map((item) => (
            <Link
              ...
              className={cn(
                ...
                isActive(item.href) ? "text-violet-500" : "text-muted-foreground",
              )}
            >
