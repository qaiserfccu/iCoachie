          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80 glass-card border-white/20">
              ...
              <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
                ...
                <span className="text-xs text-muted-foreground">Sarah wants to book a session</span>
              </DropdownMenuItem>
              <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
                <span className="font-medium">Payment Received</span>
                <span className="text-xs text-muted-foreground">$75 from John Smith</span>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="glass-subtle rounded-xl flex items-center gap-3 px-3">
                <Avatar className="h-8 w-8">
                  <AvatarImage src="/placeholder.svg?key=ttzpv" />
                ...
                <div className="hidden md:block text-left">
                  ...
                  <p className="text-xs text-muted-foreground">Freelance Coach</p>
                </div>
              </Button>
            </DropdownMenuTrigger>
