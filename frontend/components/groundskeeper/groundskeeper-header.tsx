...
import { Search, Menu, Shovel, Wifi, WifiOff } from "lucide-react"
...
export function GroundskeeperHeader() {
      ...
      <div className="flex items-center justify-between p-4">
        <div className="flex items-center gap-4 lg:hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">Groundskeeper</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <GlobalNotifications />
          <Avatar className="h-9 w-9 border-2 border-lime-500/50">
            <AvatarFallback className="bg-gradient-to-br from-lime-500 to-green-600 text-white text-sm">GK</AvatarFallback>
          </Avatar>
        </div>
      </div>
    </header>
