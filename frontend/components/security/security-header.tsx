...
import { Search, Menu, Shield, Wifi, WifiOff } from "lucide-react"
      ...
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Avatar className="h-9 w-9 border-2 border-slate-500/50">
            <AvatarFallback className="bg-gradient-to-br from-slate-600 to-slate-800 text-white text-sm">SC</AvatarFallback>
          </Avatar>
        </div>
      </div>
    </header>
