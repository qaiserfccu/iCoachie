...
import { Search, Menu, Sparkles, Wifi, WifiOff } from "lucide-react"
    ...
    <header className="sticky top-0 z-30 glass border-b border-white/20">
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Avatar className="h-9 w-9 border-2 border-sky-500/50">
            <AvatarFallback className="bg-gradient-to-br from-sky-500 to-cyan-500 text-white text-sm">CL</AvatarFallback>
          </Avatar>
        </div>
      </div>
    </header>
