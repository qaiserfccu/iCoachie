...
const recentTickets = [
  ...
  },
  {
    id: "TKT-1232",
    user: "Mike Johnson",
    issue: "Session booking not showing",
    priority: "medium",
    status: "open",
    time: "32 min ago",
    avatar: "MJ",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="glass-card border-white/20">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Badge className="bg-green-500/20 text-green-600">All Systems Up</Badge>
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="glass-card border-white/20">
          ...
          <CardContent className="space-y-2">
            {[
              { label: "Reset User Password", icon: Users, color: "text-purple-500" },
              { label: "View System Logs", icon: Activity, color: "text-blue-500" },
              { label: "Check Database", icon: Database, color: "text-green-500" },
              { label: "Test Connectivity", icon: Wifi, color: "text-teal-500" },
            ].map((action) => (
              <Button
                key={action.label}
                variant="ghost"
        ...
        <Card className="glass-card border-white/20 lg:col-span-2">
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4">
              {[
                { icon: Server, label: "Servers", value: "12/12", status: "All Healthy" },
                { icon: Database, label: "Databases", value: "3/3", status: "Replicated" },
                { icon: Wifi, label: "CDN Nodes", value: "8/8", status: "Active" },
              ].map((item) => (
