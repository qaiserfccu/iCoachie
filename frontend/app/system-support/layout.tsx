...
import { SystemSupportSidebar } from "@/components/system-support/system-support-sidebar"
import { SystemSupportHeader } from "@/components/system-support/system-support-header"

export default function SystemSupportLayout({ children }: { children: React.ReactNode }) {
  return (
