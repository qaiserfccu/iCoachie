...
import { ContentManagerSidebar } from "@/components/content-manager/content-manager-sidebar"
import { ContentManagerHeader } from "@/components/content-manager/content-manager-header"
  ...
  return (
    <div className="min-h-screen gradient-mesh relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="lg:pl-72"><ContentManagerHeader /><main className="p-4 lg:p-6">{children}</main></div>
      </div>
    </div>
  )
}
