...
import { BookingsCoordinatorSidebar } from "@/components/bookings-coordinator/bookings-coordinator-sidebar"
import { BookingsCoordinatorHeader } from "@/components/bookings-coordinator/bookings-coordinator-header"

export default function BookingsCoordinatorLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen gradient-mesh relative overflow-hidden">
      ...
      <div className="relative z-10">
        <BookingsCoordinatorSidebar />
        <div className="lg:pl-72">
          <BookingsCoordinatorHeader />
