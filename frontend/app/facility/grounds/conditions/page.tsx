...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Ground Conditions</h1>
      ...
      <div className="glass-card rounded-2xl p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-lg font-semibold">Ground Conditions</h2>
            <p className="text-sm text-muted-foreground">Manage ground conditions</p>
          </div>
        </div>
