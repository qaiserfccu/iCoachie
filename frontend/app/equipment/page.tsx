...
const stats = [
  { title: "Active Tasks", value: "12", subtitle: "In progress", color: "from-teal-500 to-teal-600" },
    ...
    <div className="space-y-6 p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Manage Equipment operations and tasks</p>
        </div>
