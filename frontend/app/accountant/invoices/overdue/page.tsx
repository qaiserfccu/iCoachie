...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Overdue Invoices</h1>
        <p className="text-muted-foreground">View overdue invoices</p>
      </div>
      <div className="glass-card rounded-2xl p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Manage overdue invoices</p>
          </div>
        </div>
