...
const stats = [
  { title: "Active Tasks", value: "12", subtitle: "In progress", color: "from-lime-500 to-lime-600" },
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Ground Dashboard</h1>
          <p className="text-muted-foreground">Manage Ground operations and tasks</p>
        </div>
